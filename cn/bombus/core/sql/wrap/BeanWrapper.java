...
import cn.bombus.core.exception.ExceptionUtil;
import cn.bombus.core.exception.ReflectionException;
import cn.bombus.core.reflect.Invoker;
...
public class BeanWrapper extends BaseWrapper {
	...
	private Object getBeanProperty(PropertyTokenizer prop, Object object) {
		try {
			...
			throw new ReflectionException(
					"Could not get property '" + prop.getName() + "' from " + object + ".  Cause: " + t.toString(), t);
		}
	}
	...
	private void setBeanProperty(PropertyTokenizer prop, Object object, Object value) {
		try {
			...
			throw new ReflectionException("Could not set property '" + prop.getName() + "' of '" + object
