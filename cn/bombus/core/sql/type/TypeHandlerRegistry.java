...
public final class TypeHandlerRegistry {
	...
	// EnumMap<JdbcType, TypeHandler>(JdbcType.class);
	// private final Map<Class<?>, Map<JdbcType, TypeHandler>> TYPE_HANDLER_MAP
	// = new HashMap<Class<?>, Map<JdbcType, TypeHandler>>();
	...
	// {
	// MappedJdbcTypes mappedJdbcTypes = (MappedJdbcTypes)
	// handler.getClass().getAnnotation(MappedJdbcTypes.class);
	...
	// MappedTypes mappedTypes = (MappedTypes)
	// handler.getClass().getAnnotation(MappedTypes.class);
	// if (mappedTypes != null)
	// {
	...
	// "Unable to get mapped types, check @MappedTypes annotation for type
	// handler " + handler);
	// }
	// }
	//
	// public void register(Class<?> type, JdbcType jdbcType, TypeHandler
	// handler)
	// {
	...
	// catch (Exception e)
	// {
	// throw new RuntimeException("Unable to find a usable constructor for " +
	// type, e);
	// }
	// }
	// }
